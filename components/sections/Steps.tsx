...
import { AnimateImage, AnimateListItem, AnimateTitle2, TitleY } from "../ui/AnimateMotion";
  ...
  return (
    <section>
      <motion.h3
        {...TitleY}
        {...AnimateTitle2}
        className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight mb-14 text-center"
      >
        Como {""}
      ...
      <div className="flex flex-wrap justify-between items-center gap-8">
            ...
            {items.map((item, index) => (
              ...
              >
                ...
                <div className="texto lg:max-w-[543px] space-y-5 gap-6">
                  <h5 className="text-lg sm:text-xl font-semibold">{item.title}</h5>
        ...
        <motion.div {...AnimateImage} className="w-full md:w-auto">
          <Image
